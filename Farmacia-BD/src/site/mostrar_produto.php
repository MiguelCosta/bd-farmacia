...
<table width="776" height="592" border="0" cellpadding="0" cellspacing="0" class="frame" id="Table_01">
	...
	<tr>
	  <td height="391" colspan="12" align="center">

	    
	    <p>&nbsp;</p>
	    <p><span class="text1">Detalhes do Produto</span></p>
	    <?php
			$connect = ocilogon("MIGUEL","433433","localhost");
			$stmt = ociparse($connect,"SELECT * FROM produtos WHERE produto = '".$_GET['prod_id']."'");
